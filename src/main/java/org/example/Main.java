...
public class Main {
    ...
    static void execute(ThreadType threadType, int threads) throws InterruptedException {
        ...
        System.out.println("Thread Type: " + threadType + " Thread Count " + threads+" Time: " + timeElapsed + " ms");
    }
}